...
<div class="modal fade" id="myModal_disapprove<?php echo $row['id'];?>"> 
  <div class="modal-dialog modal-l">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title"><strong> Disapprove Customer</strong></h4>
      ...
      <div class="container">
        ...
        <form action="../admin/Adisapprove_user.php" method="POST">
        <div class="row">
                    <div class="mb-3">
                    ...
                    <p><i class="text-danger">Customer's privelege to this system will be removed.</i></p>
