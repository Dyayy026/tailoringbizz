...
<div class="modal fade" id="myModal_delete<?php echo $row['id'];?>"> 
  <div class="modal-dialog modal-l">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title"><strong> Delete Customer</strong></h4>
      ...
      <div class="container">
        ...
        <form action="../admin/Adelete_user.php" method="POST">
        <div class="row">
                    <div class="mb-3">
                    ...
                    <p><i class="text-danger">Are you sure to delete this customer?</i></p>
            <button type="submit" class="btn btn-danger mt-5">Delete Customer</button>
