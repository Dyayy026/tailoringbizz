...
<div class="modal fade" id="myModal_approve<?php echo $row['id'];?>"> 
  <div class="modal-dialog modal-l">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title"><strong> Approve Customer</strong></h4>
      ...
      <div class="container">
        ...
        <form action="../admin/Aapprove_user.php" method="POST">
        <div class="row">
                    <div class="mb-3">
                    ...
                    <p><i class="text-dark">Approve this user to give him/her privelege to use the system.</i></p>
